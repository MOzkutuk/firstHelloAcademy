    ...
    <ul style="display: inline">
        ...
        <li>
            <form action="forward-teacher">
                <button class="button button1">Teacher</button>
            </form>
        </li>
        <li>
            <form action="forward-subject">
                <button class="button button1">Subject</button>
            </form>
        </li>
        <li>
            <form action="forward-class-report">
                <button class="button button1">Class Report</button>
            </form>
        </li>
    </ul>
</div>
...
<div class="admin-page-bilgilendirme-kutusu-2">
    ...
    <ul>
        <li>Adding Data : <p style="color: #4CAF50">Creating a new data for the chosen data class by entering that data
            class's mandatory information.</p></li>
        <li>Updating Data : <p style="color:#4CAF50 ">Updating the existing data for the chosen data class.</p></li>
        <li>Deleting Data : <p style="color:#4CAF50 ">Deleting the existing data for the choosen data class. Make sure
            the data exists.</p></li>
        <li>Get Data : <p style="color:#4CAF50 ">Receiving all the existing data for the chosen data class.</p></li>
        <li>Get Data By Its ID : <p style="color:#4CAF50 ">Receiving the data information based on the provided its data
            ID.</p></li>
    </ul>
</div>
