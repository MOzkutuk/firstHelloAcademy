...
<jsp:useBean id="teacher" class="com.firstHelloWorld.firstHelloAcademy.api.Teacher" scope="request"></jsp:useBean>
<!DOCTYPE html>
<html>
<head>
...
<div align="center">
  ...
  <form action="forward-teacher"><button class="button button1">See Teachers</button></form>
